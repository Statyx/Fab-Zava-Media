...
Produces:
  Reference / plan / actuals (Lakehouse, NonTimeSeries binding)
      data/raw/dim_advertiser.csv     data/raw/dim_brand.csv
      data/raw/dim_market.csv         data/raw/dim_channel.csv
      data/raw/dim_media_owner.csv    data/raw/dim_campaign.csv
      data/raw/dim_date.csv
      data/raw/fact_plan.csv          data/raw/fact_delivery.csv
      data/raw/fact_billing.csv
  Live pacing (Eventhouse, TimeSeries binding)
      data/raw/pacing_events.csv
