...
Usage:
    ...
    python -m foundry.verify_foundry --question "..."     # ad-hoc, prints the trace
"""
...
from fabric._shared.helpers import load_config, load_state, print_step
from foundry.foundry_common import banner, die, foundry_credential, require
