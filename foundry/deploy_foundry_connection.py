...
Usage:
    ...
    python -m foundry.deploy_foundry_connection --portal-steps    # the legacy manual path
    python -m foundry.deploy_foundry_connection --delete
"""
...
from fabric._shared.helpers import load_config, load_state, save_state, print_step, require_state
...
def main() -> int:
    ...
    print("    Next: python -m foundry.deploy_foundry_agents")
    return 0
