...
from fabric._shared.helpers import (load_config, load_state, get_fabric_token, fabric_headers,
...
STEPS = [
    ("generate_data",   "design.notebooks.generate_data"),
    ...
    ("eventhouse",      "fabric.realtime.deploy_eventhouse"),
    ("preload_pacing",  "fabric.realtime.preload_pacing"),
